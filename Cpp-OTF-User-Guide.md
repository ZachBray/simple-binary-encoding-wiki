...
For details of the `Field` class, see the header file [here](https://github.com/real-logic/simple-binary-encoding/tree/master/sbe-tool/src/main/cpp/otf_api/Field.h) or the doxygen doc. Below is an example of accessing various field methods, types, etc. from the [example](https://github.com/real-logic/simple-binary-encoding/blob/master/sbe-samples/src/main/cpp/SbeOtfDecoder.cpp).
...
For details of the `Group` class, see the header file [here](https://github.com/real-logic/simple-binary-encoding/tree/master/sbe-tool/src/main/cpp/otf_api/Group.h) or the doxygen doc. Below is an example of usage from the [example](https://github.com/real-logic/simple-binary-encoding/blob/master/sbe-samples/src/main/cpp/SbeOtfDecoder.cpp).
